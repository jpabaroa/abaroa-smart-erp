...
def apply_theme():
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* Solo el texto de los botones hereda Outfit, sin tocar íconos Material */
    .stButton > button p,
    .stButton > button span:not([class*="material"]) {
        font-family: 'Outfit', sans-serif !important;
    }
    /* Botón primario */
    ...
    @media (max-width: 768px) {
        ...
        /* Sidebar móvil: overlay nativo de Streamlit */
        ...
        /* Header horizontal: convertir en scroll horizontal en vez de stack vertical */
        ...
        /* Nav pills del header: más pequeños en móvil */
